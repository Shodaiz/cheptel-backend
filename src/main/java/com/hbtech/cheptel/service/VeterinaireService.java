...
public class VeterinaireService {
    ...
    public HealthSheetResponse.VaccinationDto addVaccination(
        ...
        HealthRecord record = HealthRecord.builder()
                .animal(animal)
                .recordType(com.hbtech.cheptel.entity.RecordType.VACCINATION)
                .veterinarian(veterinarian)
                .visitDate(request.getVaccinationDate() == null
                        ? java.time.LocalDateTime.now()
                        : request.getVaccinationDate().atStartOfDay())
                .build();
    ...
    public HealthSheetResponse.HealthRecordDto addHealthRecord(
        ...
        HealthRecord record = HealthRecord.builder()
                ...
                .nextVisitDate(request.getNextVisitDate() == null ? null : request.getNextVisitDate().toLocalDate())
                .build();
